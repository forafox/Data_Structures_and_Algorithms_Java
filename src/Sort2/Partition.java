package Sort2;
/*
Выполнение процесса разбиения.
Метод partitionIt() всегда использует в качестве опорного элемент с наибольшим индексом (крайний правый) вместо произвольного числа
 */
class ArrayPart {
    private int[] a;
    private int nElems;
